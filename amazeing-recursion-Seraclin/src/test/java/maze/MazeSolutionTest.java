...
public class MazeSolutionTest {
	...
	@Test(timeout = 500)
	public void testSimpleMaze2() {
		Room r0 = builder.createRoom("This is an entrance", "very simple.");
		Room r1 = builder.createExit("This is an exit", "very simple.");
		...
		ListInterface<Room> rooms = solution.getSolution();
		assertFalse(rooms.isEmpty());
		assertEquals("The solution should contain 2 rooms", 2, rooms.size());
		assertEquals("The one room should be the exit.", r1, rooms.get(1));
	}
