...
public class ExpressLineTest {
	...
	public void setUp() throws Exception {
		...
		LinkedList<GroceryInterface> exactBeef = new LinkedList<GroceryInterface>();
		for(int i = 0; i < 16; i++)
			exactBeef.add(Groceries.getBeef());

		feat = new Shopper(exactBeef);
	}
	...
	public void test2() {
		CheckoutLineInterface col = Configuration.getExpressLine();
		assertFalse(col.canEnterLine(feat));
	}
