...
public class SimpleRegisterTest {
	...
	public void testCreateTransaction3() {
		...
		Shopper alphonse = new Shopper(groceries);

		Transaction t = register.createTransaction(alphonse);

		assertNotNull("The returned transaction should not be null.",t);
		assertEquals("The grocery lists should be equal.", groceries, t.getReceipt().getGroceries());
		assertEquals("The shopper should match.", alphonse, t.getShopper());
		assertEquals("The number of time steps should be 1.", 1, t.getTimeSteps());
	}
