...
public class SimpleGroceryStoreTest {
	...
	public void testSimpleStoreWorld() {
		...
		assertEquals(totalSales, store.getTotalSales(), 0); // 108.87
		assertEquals(totalSales - totalCost, store.getTotalProfit(), 0.00001);
		assertEquals(99, store.getAverageWaitingTime(), 0.00001); // how to test this?
