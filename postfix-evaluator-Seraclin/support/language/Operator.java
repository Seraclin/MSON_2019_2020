...
public interface Operator<T> {
  ...
  /**
   * Get precedence of the operator and returns the resulting precedence.
   * @return the precedence int value of the operator; higher precedence is higher priority
   * @throws IllegalStateException if the required {@link Operator}s were not set.
   */
