...
// TODO test: manually perc/not perc. (done), edges, backwash, and just short of perc.
  @Before
  public void setup() {
  ...
  @Test
  public void testPecAlmostButNo() {
    grid10.open(1, 1);
    grid10.open(2, 1);
    grid10.open(3, 1);
    grid10.open(4, 1);
    ...
    assertTrue("9, 1 is connected and should be full",
            grid10.isFull(9, 1));
    assertFalse("Should not percolation", grid10.percolates());
  }

  @Test
  public void testPecYes() {
    grid10.open(1, 1);
    grid10.open(2, 1);
    grid10.open(3, 1);
    grid10.open(4, 1);
    ...
    assertTrue("10, 1 is connected and should be full",
            grid10.isFull(10, 1));
    assertTrue("Should percolation", grid10.percolates());
  }
  ...
  public void testGap() {
    ...
    grid10.open(6, 1);
    grid10.open(7, 1);
    //grid10.open(8, 1); not here
    grid10.open(9, 1);
    grid10.open(10, 1);

    assertTrue("7, 1 is connected and should be full", grid10.isFull(7, 1));

    assertTrue("7 is open", grid10.isOpen(7, 1));
    assertFalse("8 is not open", grid10.isOpen(8, 1));
    assertTrue("9 is open", grid10.isOpen(9, 1));
    assertTrue("10 is open", grid10.isOpen(10, 1));

    assertFalse("9, 1 is not connected and should not be full", grid10.isFull(9, 1));
    assertFalse("10, 1 is not connected and should not be full", grid10.isFull(10, 1));
    assertFalse("Should not percolate", grid10.percolates());
  }
